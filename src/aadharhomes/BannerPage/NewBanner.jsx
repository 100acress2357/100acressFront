      ...
      <Wrapper className="section" style={{ overflow: "hidden", overflowX: "hidden" }}>
        ...
        <>
          ...
          <div>
            <div className="sticky-quote-cta">
              <a
                ...
                onClick={handleShowInstantcallBack}
                style={{ backgroundColor: "#4F8BA9", padding: "10px" }}
              >
                Download Brochure
              </a>
              {instantcallbackmodal && (
                <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-75">
                  <div className="relative w-[19rem] sm:w-full md:w-[20rem] mx-auto my-4 overflow-hidden rounded-t-2xl bg-[#4F8BA9] shadow-lg max-w-lg max-w-lg] h-[25rem]">
                    ...
                    <div className="space-y-4 px-8 py-4 rounded-t-2xl">
                      <div className="relative"  >
                        ...
                        ></i>
                        <input
                          className="peer w-full pl-10 py-2 rounded-lg bg-[#4F8BA9] text-white focus:ring-1 focus:ring-blue-500 border border-red outline-none placeholder-transparent focus:bg-[#4F8BA9]"
                          type="text"
                          name="name"
                          placeholder="Name"
                        ...
                        />
                        <span
                          className="absolute left-7 -top-3 px-2 bg-[#4F8BA9] text-grey-500 text-base transition-all duration-300 transform scale-75 
                            peer-valid:text-white
                            pointer-events-none peer-placeholder-shown:top-2 peer-placeholder-shown:scale-100 peer-placeholder-shown:bg-transparent peer-placeholder-shown:text-[#B8B8B8] peer-focus:-top-2 peer-focus:bg-[#4F8BA9] peer-focus:text-[#D0D0D0]"
                        >
                          Name
                        </span>
                      </div>
                      ...
                      <div className="relative">
                        ...
                        <input
                          className="peer w-full pl-10 py-2 rounded-lg bg-[#4F8BA9] text-white focus:ring-1 focus:ring-blue-500 border border-[#707070] outline-none placeholder-transparent focus:bg-[#4F8BA9]"
                          type="tel"
                          name="mobile"
                        ...
                        <span
                          className="absolute left-7 -top-3 px-2 bg-[#263238] text-gray-700 text-base transition-all duration-300 transform scale-75 
                            pointer-events-none peer-valid:text-white peer-placeholder-shown:top-2 peer-placeholder-shown:scale-100 peer-placeholder-shown:bg-transparent peer-placeholder-shown:text-[#B8B8B8] peer-focus:-top-2 peer-focus:bg-[#4F8BA9] peer-focus:text-white"
                        >
                          Contact No
                        </span>
                      </div>
                      ...
                      <div className="relative">
                        ...
                        <span
                          className="absolute left-7 -top-3 px-2 bg-[#263238] text-grey-500 text-base transition-all duration-300 transform scale-75 
                            pointer-events-none peer-valid:text-white peer-placeholder-shown:top-2 peer-placeholder-shown:scale-100 peer-placeholder-shown:bg-transparent peer-placeholder-shown:text-[#B8B8B8] peer-focus:-top-2 peer-focus:bg-[#4F8BA9]Frelative inline-block transition-all px-3 duration-500 peer-focus:text-white"
                        >
                          Email (Optional)
                        </span>
                      </div>
                      ...
                      <div className="flex justify-center">
                        <button
                          className="group mt-2 w-full md:w-auto rounded-md bg-[#4F8BA9] px-10 py-2 font-semibold text-white border border-gray-600 outline-none relative overflow-hidden transition-all duration-500 hover:pr-10 flex items-center justify-center"
          ...
          <div className="relative">
            {showPopup && (
              <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-75">
                <div className="relative w-[19rem] sm:w-full md:w-[20rem] mx-auto my-4 overflow-hidden rounded-2xl bg-[#4F8BA9] shadow-lg max-w-lg h-[25rem] ">
                  <div className="bg-radial-custom px-5 py-2 text-center text-white relative">
                    <p className="font-serif text-xl mb-0 text-center font-semibold tracking-wider">
                      Instant Callback
                    </p>
                ...
                <div className="mt-4 mx-4">
                  <div className="flex flex-col w-full border-black border border-black-700">
                    <div className="flex flex-shrink-0 bg-[#4F8BA9] text-white ">
                      <div className="flex items-center justify-center flex-grow w-0 h-10 p-2 border-b  border-[#4F8BA9]">
                        <span>Unit Type</span>
                      </div>
                      <div className="flex items-center justify-center flex-grow w-0 h-10 p-2 border-b  border-[#4F8BA9]">
                        <span>Unit Size</span>
                  ...
                  <p className="text-lg flex items-center space-x-2">
                    ...
                    >
                     <span className="text-2xl"><PhoneIcon /></span>
                      <span className="text-4xl sm:text-4xl"> &nbsp; {`${projectViewDetails?.mobileNumber  === 9811750130 ? "+91 8527-134-491" : "+91 9315-375-335" }`}</span>
                    </a>
                  </p>
                ...
                <form className="space-y-5">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-4 py-3 rounded-lg bg-[#4F8BA9] text-white placeholder-gray-300 focus:ring-2 focus:ring-blue-500 border border-gray-600 outline-none "
                    />
                  </div>
                  <div>
                  ...
                  <p className='text-xs text-white'> * Your information will be kept strictly confidential and will not be shared, sold, or otherwise disclosed.</p>
                  <button
