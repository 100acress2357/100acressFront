...
function NoPropertiesMessage () {
    ...
    const handleOk = async() => {
        ...
        try {
            ...
            const response = await axios.post("http://localhost:3500/contact_Insert",enquiry)
            const title = "Success";
      ...
      >
        ...
        <form>
            ...
            <div>
                ...
                <input type="email" name='email' id='email' placeholder='Please enter your email.' className='border p-2 w-full rounded' onChange={handleChange}/>
            </div>
            <div>
